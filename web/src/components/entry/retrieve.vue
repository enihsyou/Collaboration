<template>
    <div class="form">
        ...
        <div class="form__content" @keypress.enter="submit">
            <h1>找回密码</h1>
            <div class="overtime" v-if="isExpired||username===''||token===''">
                该链接已失效，请重新获取！
            </div>
            <div v-else>
                ...
                <div class="styled-input">
                    ...
                    <div class="styled-input__placeholder">
                        <span class="styled-input__placeholder-text">
                            <span class="letter" v-for="char in '新密码'">{{char}}</span>
                        </span>
                    </div>
                    <div class="styled-input__circle"></div>
                </div>
                <div class="styled-input">
                    ...
                    <div class="styled-input__placeholder">
                        <span class="styled-input__placeholder-text">
                            <span class="letter" v-for="char in '确认新密码'">{{char}}</span>
                        </span>
                    </div>
                    <div class="styled-input__circle"></div>
                </div>
  ...
  export default {
    ...
    methods: {
      ...
      submit() {
        ...
        this.$.ajax.post(`/user/reset?token=${this.token}`, JSON.stringify({
    ...
    created() {
      this.$.ajax.get(`/token/forgot?token=${this.token}`).then((res) => {
        console.log(res);
